...
//   return (
//     <div className="flex flex-col items-center justify-center min-w-96 mx-auto">
//       <div className="h-full w-full p-6 bg-gray-900 rounded-md bg-clip-padding backdrop-filter backdrop-blur-sm bg-opacity-50 border border-gray-100">
//         <h1 className="text-3xl font-semibold text-center text-gray-300">
//           Login
//           <span className="text-red-400"> Talkster</span>
//         </h1>
...
//           <a
//             href="#"
//             className="text-sm hover:underline hover:text-blue-300 mt-2 inline-black"
//           >
//             {"Don't"} have an account?
//           </a>

//           <div className="btn btn-block btn-md max-w-xs">Login</div>
//         </form>
//       </div>
//     </div>
//   );
